...
lb_dns, loadBalancerClass = setup_load_balancer(security_group_id, subnet_id, tg_arn)
deploy_flask()    
...
while True:
    ...
    if (line == 'i'):
        ...
        shutdown_system(id_list_m4 + id_list_t2, tg_arn, instanceClass, loadBalancerClass, targetGroupClass)
    elif (line == ''):
        continue
    else:
